...
public class Notification  implements java.io.Serializable {
    ...
    private com.fedex.async.stub.NotificationSeverityType severity;
    ...
    private com.fedex.async.stub.NotificationParameter[] messageParameters;

    public Notification() {
    }

    public Notification(
           com.fedex.async.stub.NotificationSeverityType severity,
           java.lang.String source,
           java.lang.String code,
           java.lang.String message,
           java.lang.String localizedMessage,
           com.fedex.async.stub.NotificationParameter[] messageParameters) {
     ...
     * Please try again later
     */
    public com.fedex.async.stub.NotificationSeverityType getSeverity() {
        return severity;
    }
     ...
     * Please try again later
     */
    public void setSeverity(com.fedex.async.stub.NotificationSeverityType severity) {
        this.severity = severity;
    }
     ...
     * witout having to parse the message string.
     */
    public com.fedex.async.stub.NotificationParameter[] getMessageParameters() {
     ...
     * witout having to parse the message string.
     */
    public void setMessageParameters(com.fedex.async.stub.NotificationParameter[] messageParameters) {
        this.messageParameters = messageParameters;
    }

    public com.fedex.async.stub.NotificationParameter getMessageParameters(int i) {
        return this.messageParameters[i];
    }

    public void setMessageParameters(int i, com.fedex.async.stub.NotificationParameter _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/async/v1", "Notification"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("severity");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/async/v1", "Severity"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/async/v1", "Source"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/async/v1", "Code"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/async/v1", "Message"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/async/v1", "LocalizedMessage"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/async/v1", "MessageParameters"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/async/v1", "NotificationParameter"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
