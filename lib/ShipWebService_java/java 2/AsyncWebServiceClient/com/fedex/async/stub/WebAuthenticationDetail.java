...
public class WebAuthenticationDetail  implements java.io.Serializable {
    ...
    private com.fedex.async.stub.WebAuthenticationCredential userCredential;

    public WebAuthenticationDetail() {
    }

    public WebAuthenticationDetail(
           com.fedex.async.stub.WebAuthenticationCredential userCredential) {
     ...
     * This value is provided by FedEx after registration.
     */
    public com.fedex.async.stub.WebAuthenticationCredential getUserCredential() {
     ...
     * This value is provided by FedEx after registration.
     */
    public void setUserCredential(com.fedex.async.stub.WebAuthenticationCredential userCredential) {
        this.userCredential = userCredential;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/async/v1", "WebAuthenticationDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("userCredential");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/async/v1", "UserCredential"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/async/v1", "WebAuthenticationCredential"));
