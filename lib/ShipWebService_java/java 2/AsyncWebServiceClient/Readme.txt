...
java org.apache.axis.wsdl.WSDL2Java -w -p com.fedex.async.stub <full_path>/myfile1.wsdl

example:
java org.apache.axis.wsdl.WSDL2Java -w -p com.fedex.async.stub http://www.fedex.com/...../ASYNCService_v2.wsdl
depending on your environment, you may have to use a "?" instead of "." just before "wsdl"
see the command below:
java org.apache.axis.wsdl.WSDL2Java -w -p com.fedex.async.stub http://www.fedex.com/...../ASYNCService?wsdl
or
java org.apache.axis.wsdl.WSDL2Java -w -p com.fedex.async.stub C:\projects\wsdl\ASYNCService_v1.wsdl
or similar.
